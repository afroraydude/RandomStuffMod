...
public class TeleporterTutorial extends Teleporter
{
    ...
    public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
    {
        ...
        else
        {
            for (k1 = l - short1; k1 <= l + short1; ++k1)
            {
                ...
                for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1)
                {
                    ...
                    {
                        if (this.worldServerInstance.getBlockId(k1, i2, l1) == AfroBlockManagement.afroPortalBlock.blockID)
                        {
                            while (this.worldServerInstance.getBlockId(k1, i2 - 1, l1) == AfroBlockManagement.afroPortalBlock.blockID)
                            {
                                --i2;
                            }
        ...
        if (d3 >= 0.0D)
        {
            ...
            if (this.worldServerInstance.getBlockId(i - 1, j, k) == AfroBlockManagement.afroPortalBlock.blockID)
            {
                j2 = 2;
            }
            ...
            if (this.worldServerInstance.getBlockId(i, j, k - 1) == AfroBlockManagement.afroPortalBlock.blockID)
            {
                j2 = 3;
            }
        ...
        for (k2 = 0; k2 < 4; ++k2)
        {
            for (i3 = 0; i3 < 4; ++i3)
            {
                for (l2 = -1; l2 < 4; ++l2)
                {
                    ...
                    this.worldServerInstance.setBlock(k3, j3, i4, flag ? Block.sandStone.blockID : AfroBlockManagement.afroPortalBlock.blockID, 0, 2);
                }
            }
